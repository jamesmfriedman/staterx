...
var createReducer = function (_a) {
    var constant = _a.constant, generateId = _a.generateId, defaultItem = _a.defaultItem;
        ...
        switch (type) {
            ...
            case constant.UPDATE:
                var newUpdatedItems = items.reduce(function (acc, item) {
                    var existing = state[item.id] || __assign({ id: generateId() }, (typeof defaultItem === 'function' ? defaultItem() : defaultItem));
                    acc[item.id] = __assign(__assign({}, existing), item);
                    return acc;
                }, {});
...
export var createItems = function (options) {
    ...
    return createStateRx(options, {
        ...
        createReducer: function (params) {
            return createReducer(__assign(__assign({}, params), { generateId: generateId,
