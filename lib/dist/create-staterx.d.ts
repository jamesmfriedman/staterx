...
export declare const createStateRx: <T, State, Effects, ConstantsArray extends string[], Actions extends {}, Selectors extends {}, Api extends CreateStateRxApi<State>>(options: CreateStateRxOpts<Effects, Api, State>, overrides: {
